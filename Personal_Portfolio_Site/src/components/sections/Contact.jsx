...
export default function Contact() {
    ...
    return (
        ...
        >
            <h1 className='text-white leading-normal md:leading-snug xl:leading-snug font-extrabold text-4xl md:text-6xl xl:text-8xl'>Say hello!</h1>
            <div className='flex'>
                <div
                ...
                <Link to="mailto:p.grzesiewicz@gmail.com"
                      className='font-serif flex items-end select-all font-light text-yellow-3 hover:text-yellow-1 text-2xl md:text-4xl xl:text-5xl ml-2 md:ml-4 xl:ml-6'>
                    Write an E-mail
                </Link>
            </div>
