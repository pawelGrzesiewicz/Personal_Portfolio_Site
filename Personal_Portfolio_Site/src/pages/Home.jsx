...
export default function Home() {
    ...
    return (
        <div style={{ backgroundImage: 'url(./src/assets/bg.jpg)', height: '100vh' }}
             className=' box-border grid grid-cols-6 grid-rows-6 bg-black p-4 sm:p-6 lg:p-8'>
          ...
          p.grzesiewicz@gmail.com
            ...
            <main onWheel={handleScroll} className='row-start-2 col-span-6 md:col-span-4 lg:col-span-3 col-start-1 row-span-5'>
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <div className='flex flex-col items-center'>
                                                <div className={`h-2 w-2 mb-2.5  mt-2.5 outline outline-2 outline-yellow-3 outline-offset-2 rotate-45 ${activeLink === sectionId ? 'bg-yellow-1' : ''}`}></div>
